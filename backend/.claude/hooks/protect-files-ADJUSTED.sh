...
# ADJUSTED FOR PT MANAGER: Added migrations and Supabase checks
...
case "$PATH_LC" in
  ...
  supabase/migrations/*|*/supabase/migrations/*)
    emit deny "Database migrations must be created via Supabase CLI, not edited manually. Use: supabase migration new {name}" ;;
  supabase/seed.sql|*/supabase/seed.sql)
    emit ask "Editing seed.sql. This affects all environments. Review changes carefully." ;;
