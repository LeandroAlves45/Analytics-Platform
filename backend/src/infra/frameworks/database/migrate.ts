...
const MIGRATIONS_FOLDER = resolve(process.cwd(), 'src/infra/frameworks/database/migrations');

const HYPERTABLES_SQL_PATH = resolve(process.cwd(), '../docker/init_hypertables.sql');
