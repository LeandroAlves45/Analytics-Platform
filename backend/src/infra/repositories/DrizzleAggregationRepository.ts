...
export class DrizzleAggregationRepository {
  ...
  async save(result: AggregationResult): Promise<void> {
    ...
    const values = {
      ...
      latencyP50: result.latencyP50 ?? null,
      latencyP75: result.latencyP75 ?? null,
      latencyP95: result.latencyP95 ?? null,
      latencyP99: result.latencyP99 ?? null,
      latencyAvg: result.latencyAvg ?? null,
      latencyMin: result.latencyMin ?? null,
      latencyMax: result.latencyMax ?? null,
      status2xxCount: result.status2xxCount ?? null,
      status3xxCount: result.status3xxCount ?? null,
      status4xxCount: result.status4xxCount ?? null,
      status5xxCount: result.status5xxCount ?? null,
    };
